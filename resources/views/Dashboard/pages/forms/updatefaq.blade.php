        ...
        <div class="col-12 grid-margin stretch-card">
          <div class="card shadow-lg">
            <div class="card-body">
              ...
              <form class="forms-sample" id="faqForm" action="{{route("update_faq",$faq->id)}}" method="POST">
                @csrf
                ...
                <!-- Answer Input Field -->
                <div class="form-group">
                  <label for="faqAnswer">Description</label>
                  <textarea 
                    class="form-control" 
                    id="faqAnswer" 
                    name="faqdescription" 
                    placeholder="Enter the FAQ answer...">{{$faq->description}}</textarea>
