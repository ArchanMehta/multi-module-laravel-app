<section>
    ...
    <form method="post" action="{{ route('user-profile-information.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-input-error class="mt-2" :messages="$errors->updateProfileInformation->get('phone')" />
        </div>
        ...
        <div>
            ...
            <x-input-error class="mt-2" :messages="$errors->updateProfileInformation->get('age')" />
        </div>
        ...
        <div>
            ...
            <x-input-error class="mt-2" :messages="$errors->updateProfileInformation->get('city')" />
        </div>
